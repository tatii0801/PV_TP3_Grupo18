const proyectos = [
  {
    ...
    descripcion: `Sistema diseñado para administrar libros, préstamos y usuarios dentro de una institución educativa. Permite registrar, organizar y consultar el catálogo bibliográfico de manera eficiente, facilitando el acceso a la información y el control de los recursos disponibles.
...

  {
    ...
    descripcion: `Página web desarrollada para mostrar información institucional, brindando a estudiantes, docentes y familias un acceso rápido y organizado a los datos más relevantes de la institución educativa. Su diseño facilita la navegación y la consulta de contenidos de manera clara y accesible.
...

  {
    ...
    descripcion: `Aplicación creada para organizar tareas académicas y mejorar la productividad de los estudiantes. Permite gestionar actividades, establecer prioridades y llevar un seguimiento de las responsabilidades escolares de manera sencilla y eficiente.
...

  {
    ...
    descripcion: `Sistema orientado a gestionar las inscripciones de estudiantes en cursos y materias universitarias. Permite registrar, actualizar y consultar la información académica de manera organizada, facilitando el proceso de matriculación dentro de la institución.
...

  {
    ...
    descripcion: `Plataforma virtual diseñada para compartir contenidos educativos, facilitando el acceso a materiales de estudio, recursos didácticos y documentos relevantes para el proceso de aprendizaje. Su entorno digital permite una interacción más dinámica entre estudiantes y docentes.
